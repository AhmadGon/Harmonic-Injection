-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ThreeSines_DrSaher\HEX3.vhd
...
-- 
-- Module: HEX3
-- Source Path: ThreeSines_DrSaher/Sines /HEX3
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF HEX3 IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT Wrap_To_Zero_block2
  ...
  FOR ALL : Wrap_To_Zero_block2
    USE ENTITY work.Wrap_To_Zero_block2(rtl);

  FOR ALL : Subsystem_block2
    USE ENTITY work.Subsystem_block2(rtl);

  FOR ALL : Subsystem2_block2
    USE ENTITY work.Subsystem2_block2(rtl);

  FOR ALL : Subsystem3_block2
    USE ENTITY work.Subsystem3_block2(rtl);

  FOR ALL : Subsystem4_block2
    USE ENTITY work.Subsystem4_block2(rtl);

  FOR ALL : Subsystem5_block2
    USE ENTITY work.Subsystem5_block2(rtl);

  FOR ALL : Subsystem6_block2
    USE ENTITY work.Subsystem6_block2(rtl);

  FOR ALL : Subsystem7_block2
    USE ENTITY work.Subsystem7_block2(rtl);

  FOR ALL : Subsystem8_block2
    USE ENTITY work.Subsystem8_block2(rtl);

  FOR ALL : Subsystem17_block2
    USE ENTITY work.Subsystem17_block2(rtl);

  FOR ALL : Subsystem18_block2
    USE ENTITY work.Subsystem18_block2(rtl);

  FOR ALL : Subsystem9_block2
    USE ENTITY work.Subsystem9_block2(rtl);

  FOR ALL : Subsystem10_block2
    USE ENTITY work.Subsystem10_block2(rtl);

  FOR ALL : Subsystem11_block2
    USE ENTITY work.Subsystem11_block2(rtl);

  FOR ALL : Subsystem12_block2
    USE ENTITY work.Subsystem12_block2(rtl);

  FOR ALL : Subsystem13_block2
    USE ENTITY work.Subsystem13_block2(rtl);

  FOR ALL : Subsystem14_block2
    USE ENTITY work.Subsystem14_block2(rtl);

  FOR ALL : Subsystem15_block2
    USE ENTITY work.Subsystem15_block2(rtl);

  FOR ALL : Subsystem16_block2
    USE ENTITY work.Subsystem16_block2(rtl);

  FOR ALL : Subsystem19_block2
    USE ENTITY work.Subsystem19_block2(rtl);

  FOR ALL : Subsystem20_block2
    USE ENTITY work.Subsystem20_block2(rtl);
...
BEGIN
  u_Wrap_To_Zero : Wrap_To_Zero_block2
  ...
  u_Subsystem2 : Subsystem2_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem3 : Subsystem3_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem4 : Subsystem4_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem5 : Subsystem5_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem6 : Subsystem6_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem7 : Subsystem7_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem8 : Subsystem8_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem17 : Subsystem17_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem18 : Subsystem18_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem9 : Subsystem9_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem10 : Subsystem10_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem11 : Subsystem11_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem12 : Subsystem12_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem13 : Subsystem13_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem14 : Subsystem14_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem15 : Subsystem15_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem16 : Subsystem16_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem19 : Subsystem19_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem20 : Subsystem20_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Unit_Delay_out1 <= Push_3;
      END IF;
    END IF;
  END PROCESS Unit_Delay_process;


  Logical_Operator1_out1 <= Push_3 XOR Unit_Delay_out1;

  Logical_Operator_out1 <= Push_3 AND Logical_Operator1_out1;
  ...
  HEX3_1 <= std_logic_vector(Multiport_Switch_out1);
  ...
  Data_Type_Conversion1_out1 <= Sum_out1(18 DOWNTO 0) & '0';
