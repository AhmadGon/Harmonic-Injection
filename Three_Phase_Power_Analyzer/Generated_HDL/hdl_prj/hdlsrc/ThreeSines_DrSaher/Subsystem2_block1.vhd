-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ThreeSines_DrSaher\Subsystem2_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem2_block1
-- Source Path: ThreeSines_DrSaher/Sines /HEX2/Subsystem2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Subsystem2_block1;


ARCHITECTURE rtl OF Subsystem2_block1 IS
...
BEGIN
  ...
  Constant9_out1 <= to_unsigned(16#79#, 7);
