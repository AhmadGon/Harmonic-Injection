-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ThreeSines_DrSaher\HEX1.vhd
...
-- 
-- Module: HEX1
-- Source Path: ThreeSines_DrSaher/Sines /HEX1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF HEX1 IS
  ...
  FOR ALL : Subsystem2_block
    USE ENTITY work.Subsystem2_block(rtl);

  FOR ALL : Subsystem3_block
    USE ENTITY work.Subsystem3_block(rtl);

  FOR ALL : Subsystem4_block
    USE ENTITY work.Subsystem4_block(rtl);

  FOR ALL : Subsystem5_block
    USE ENTITY work.Subsystem5_block(rtl);

  FOR ALL : Subsystem6_block
    USE ENTITY work.Subsystem6_block(rtl);

  FOR ALL : Subsystem7_block
    USE ENTITY work.Subsystem7_block(rtl);

  FOR ALL : Subsystem8_block
    USE ENTITY work.Subsystem8_block(rtl);

  FOR ALL : Subsystem17_block
    USE ENTITY work.Subsystem17_block(rtl);

  FOR ALL : Subsystem18_block
    USE ENTITY work.Subsystem18_block(rtl);

  FOR ALL : Subsystem9_block
    USE ENTITY work.Subsystem9_block(rtl);

  FOR ALL : Subsystem10_block
    USE ENTITY work.Subsystem10_block(rtl);

  FOR ALL : Subsystem11_block
    USE ENTITY work.Subsystem11_block(rtl);

  FOR ALL : Subsystem12_block
    USE ENTITY work.Subsystem12_block(rtl);

  FOR ALL : Subsystem13_block
    USE ENTITY work.Subsystem13_block(rtl);

  FOR ALL : Subsystem14_block
    USE ENTITY work.Subsystem14_block(rtl);

  FOR ALL : Subsystem15_block
    USE ENTITY work.Subsystem15_block(rtl);

  FOR ALL : Subsystem16_block
    USE ENTITY work.Subsystem16_block(rtl);

  FOR ALL : Subsystem19_block
    USE ENTITY work.Subsystem19_block(rtl);

  FOR ALL : Subsystem20_block
    USE ENTITY work.Subsystem20_block(rtl);
  ...
  SIGNAL kconst                           : signed(21 DOWNTO 0);  -- sfix22_En27
  SIGNAL kconst_1                         : signed(21 DOWNTO 0);  -- sfix22_En27
  ...
  SIGNAL Gain_out1                        : signed(43 DOWNTO 0);  -- sfix44_En41
  SIGNAL Gain_out1_1                      : signed(43 DOWNTO 0);  -- sfix44_En41
...
BEGIN
  ...
  u_Subsystem17 : Subsystem17_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem18 : Subsystem18_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem10 : Subsystem10_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem11 : Subsystem11_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem12 : Subsystem12_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem13 : Subsystem13_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem14 : Subsystem14_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem15 : Subsystem15_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem16 : Subsystem16_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem19 : Subsystem19_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem20 : Subsystem20_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Unit_Delay_out1 <= Push_1;
      END IF;
    END IF;
  END PROCESS Unit_Delay_process;


  Logical_Operator1_out1 <= Push_1 XOR Unit_Delay_out1;

  Logical_Operator_out1 <= Push_1 AND Logical_Operator1_out1;
  ...
  HEX1_1 <= std_logic_vector(Multiport_Switch_out1);

  kconst <= to_signed(16#147AE1#, 22);
  ...
  Data_Type_Conversion1_out1 <= resize(Gain_out1_1(43 DOWNTO 26), 20);
