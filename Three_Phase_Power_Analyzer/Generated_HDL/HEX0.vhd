-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ThreeSines_DrSaher\HEX0.vhd
...
-- 
-- Module: HEX0
-- Source Path: ThreeSines_DrSaher/Sines /HEX0
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF HEX0 IS
  ...
  FOR ALL : Subsystem17
    USE ENTITY work.Subsystem17(rtl);

  FOR ALL : Subsystem18
    USE ENTITY work.Subsystem18(rtl);
  ...
  FOR ALL : Subsystem19
    USE ENTITY work.Subsystem19(rtl);

  FOR ALL : Subsystem20
    USE ENTITY work.Subsystem20(rtl);
  ...
  SIGNAL kconst                           : signed(21 DOWNTO 0);  -- sfix22_En30
  SIGNAL kconst_1                         : signed(21 DOWNTO 0);  -- sfix22_En30
  ...
  SIGNAL Gain_out1                        : signed(43 DOWNTO 0);  -- sfix44_En44
  SIGNAL Gain_out1_1                      : signed(43 DOWNTO 0);  -- sfix44_En44
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Unit_Delay_out1 <= Push_0;
      END IF;
    END IF;
  END PROCESS Unit_Delay_process;


  Logical_Operator1_out1 <= Push_0 XOR Unit_Delay_out1;

  Logical_Operator_out1 <= Push_0 AND Logical_Operator1_out1;
  ...
  HEX0_1 <= std_logic_vector(Multiport_Switch_out1);

  kconst <= to_signed(16#10624E#, 22);
  ...
  Data_Type_Conversion1_out1 <= resize(Gain_out1_1(43 DOWNTO 29), 20);
